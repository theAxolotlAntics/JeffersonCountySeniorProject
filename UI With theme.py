...
class App(tk.Tk):
    ...
    def ApplyTheme(self):
        ...
        if self.dark_mode.get():
            ...
            # Treeview (this is key for your clean table look)
            style.configure("Treeview",
                            background=bg,
                            foreground=fg,
                            fieldbackground=bg,
            ...
            style.theme_use("clam")  # keep consistent base
            ...
            # Reset dropdown list colors
            self.option_add("*TCombobox*Listbox.background", "white")
            self.option_add("*TCombobox*Listbox.foreground", "black")
            self.option_add("*TCombobox*Listbox.selectBackground", "#cce5ff")

        #IMPORTANT: rebuild UI so styles apply everywhere
        self.BuildTree()
        self.ShowTree(self.df)
